...
if __name__ == "__main__":
    ...
    filename_after = '04_htnderv_s1_all.csv'
    ...
    t_score_p_value_before.to_csv(f'{pwd}/04_1_t_score_p_value_before.csv', index=False)
    t_score_p_value_after.to_csv(f'{pwd}/04_1_t_score_p_value_after.csv', index=False)
